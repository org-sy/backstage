...
.desc {
	...
	<h1 class="page-title"> 有趣短视频后台管理系统 </h1>
	                ...
	                <div class="row">
	                    <div class="col-md-12">
	                        <div class="mt-widget-3" style="padding-top: 15px;">
	                        	...
	                        	<p class="desc">1、核心框架：Spring Framework</p>
	                        	<p class="desc">2、架构：SpringBoot：2.1.4.RELEASE + Spring Cloud</p>
								<p class="desc">3、持久层框架：Spring-Data-JPA </p>
								<p class="desc">4、数据库:mysql</p>
								<p class="desc">5、日志采集：Flume </p>
								<p class="desc">6、消息队列：Kafka </p>
								<p class="desc">7、数据计算：Spark </p>
								<p class="desc">8、文件存储：HDFS </p>
								<p class="desc">9、搜索引擎：ElasticSearch</p>
								<p class="desc">11、缓存:Spring-Data-Redis</p>
								<p class="desc">12、音视频合成:FFmpeg：2.0.1.1</p>
								<p class="desc">13、前端框架:uni-app + vue </p>
								<p class="desc">14、服务器:Tocamt 8.5 + Nginx </p>
								<p class="desc">15、部署容器:docker </p>
	                        </div>
	                    </div>
	                </div>
	                <%----%>
